...
export default function OAuth() {
    ...
    return (
        <>
            <Field className="grid grid-cols-2 gap-4 mt-6">
                <form action={handleGoogleSignIn}>
                    <Button variant="outline" type="submit" className="w-full">
                        <svg viewBox="0 0 24 24" aria-hidden="true" className="affy afge">
                ...
                <form action={handleGithubSignIn}>
                    <Button variant="outline" type="submit" className="w-full">
                        <svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" className="affx afhm">
