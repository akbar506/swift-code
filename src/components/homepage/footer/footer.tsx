        ...
        <footer className="py-6 mt-12 border-t border-muted">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    <Link href="https://github.com/akbar506/swift-code" target="_blank" className="p-2 rounded-lg hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground">
                    ...
                    <Link href="#" target="_blank" className="p-2 rounded-lg hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground">
